...
import (
	"fmt"
	"github.com/ARMmaster17/Captain/Builder/drivers/providers"
...
// plane.
func BuildPlaneOnAnyProvider(plane Shared.Plane, formation Shared.Formation) (string, error) {
	p := providers.ConvertToGenericPlane(plane, formation)
