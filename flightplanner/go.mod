...
require (
	...
	github.com/ARMmaster17/Captain/shared/locking v0.0.0-00010101000000-000000000000
	github.com/ARMmaster17/Captain/shared/prep v0.0.0-00010101000000-000000000000
)
